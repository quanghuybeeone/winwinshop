const loadTopbar = () => {
    let topbar = document.querySelector('#topbarMenu')
    topbar.innerHTML = `<a class="navbar-brand bg-light col-md-3 col-lg-2 me-0 px-3 fs-6" href="#"><img width="100%"
    src="../asset/img/logo1.png" alt=""></a>
<button class="navbar-toggler position-absolute d-md-none collapsed border-dark bg-light my-4" type="button"
...
<div class="nav-item text-nowrap">
    <a class="nav-link px-3 text-light sign-out" href="#">Sign out</a>
</div>
</div>`
}
...
const loadSidebar = () => {
    ...
    sidebar.innerHTML = `<div class="position-sticky pt-3 sidebar-sticky bg-light">
