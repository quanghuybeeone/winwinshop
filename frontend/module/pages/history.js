        ...
        dataBills.forEach(bill => {
            if (bill.id_user == id_user) {
                ...
                if (bill.status == 1) {
                    ...
                    btn2 = `<button class="btn btn-danger btn-cancel">Hủy</button>`
                }
                html += `
            <tr>
...
// const handleConfirm = ()=>{
//     let btns_conf = document.querySelectorAll('.btn-conf')
//     btns_conf.forEach(btn_conf=>{
//         btn_conf.addEventListener('click', async(e)=>{
